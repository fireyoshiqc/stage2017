...
struct bram_pad_interlayer : public interlayer
{
    bram_pad_interlayer(size_t n_channels, size_t channel_width, size_t zero_padding, size_t layer_size)
        ...
        {
            datum("init_values",   reals_type,   Sem::data,  ""s),
            ...
            datum("rd_addr", std_logic_vector_type.with_range(clogb2(round_to_next_two(pow(layer_size + zero_padding, 2))) - 1, 0), Sem::front_offset_intake)    .in(),
