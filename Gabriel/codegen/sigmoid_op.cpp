...
sigmoid_op_component::sigmoid_op_component(pair<int, int> ospec, int step_prec, int bit_prec)
...
void sigmoid_op_component::propagate(component& prev)
{
...
string sigmoid_op_component::demand_signal(Sem sem)
{
