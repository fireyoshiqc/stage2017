...
struct fc_to_fcbin_interlayer : public interlayer
{
    fc_to_fcbin_interlayer(unsigned int width, pair<int, int> spec)
        : interlayer("fc_to_fcbin_interlayer", "fc_to_fcbin_interlayer_u" + to_string(global_counter()),
        {
