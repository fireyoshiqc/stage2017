...
struct fc_to_fc_interlayer : public interlayer
{
    fc_to_fc_interlayer(unsigned int width, pair<int, int> spec)
        : interlayer("fc_to_fc_interlayer", "fc_to_fc_interlayer_u" + to_string(global_counter()),
        {
