...
set_property PACKAGE_PIN T22 [get_ports {acc[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {acc[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {acc[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {acc[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {acc[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {acc[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {acc[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {acc[7]}];  # "LD7"

# ----------------------------------------------------------------------------
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y21  [get_ports {acc[8]}];  # "VGA-B1"
set_property PACKAGE_PIN Y20  [get_ports {acc[9]}];  # "VGA-B2"
set_property PACKAGE_PIN AB20 [get_ports {acc[10]}];  # "VGA-B3"
set_property PACKAGE_PIN AB19 [get_ports {acc[11]}];  # "VGA-B4"
set_property PACKAGE_PIN AB22 [get_ports {acc[12]}];  # "VGA-G1"
set_property PACKAGE_PIN AA22 [get_ports {acc[13]}];  # "VGA-G2"
set_property PACKAGE_PIN AB21 [get_ports {acc[14]}];  # "VGA-G3"
set_property PACKAGE_PIN AA21 [get_ports {acc[15]}];  # "VGA-G4"
set_property PACKAGE_PIN AA19 [get_ports {acc[16]}];  # "VGA-HS"
set_property PACKAGE_PIN V20  [get_ports {acc[17]}];  # "VGA-R1"
set_property PACKAGE_PIN U20  [get_ports {acc[18]}];  # "VGA-R2"
set_property PACKAGE_PIN V19  [get_ports {acc[19]}];  # "VGA-R3"
set_property PACKAGE_PIN V18  [get_ports {acc[20]}];  # "VGA-R4"
set_property PACKAGE_PIN Y19  [get_ports {acc[21]}];  # "VGA-VS"

# ----------------------------------------------------------------------------
# User Push Buttons - Bank 34
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {rst}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {enb}];  # "BTND"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {weight[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {weight[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {weight[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {weight[3]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {weight[4]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {weight[5]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {weight[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {weight[7]}];  # "SW7"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN L19 [get_ports {bias[0]}];  # "FMC-CLK0_N"
set_property PACKAGE_PIN L18 [get_ports {bias[1]}];  # "FMC-CLK0_P"
set_property PACKAGE_PIN M20 [get_ports {bias[2]}];  # "FMC-LA00_CC_N"
set_property PACKAGE_PIN M19 [get_ports {bias[3]}];  # "FMC-LA00_CC_P"
set_property PACKAGE_PIN N20 [get_ports {bias[4]}];  # "FMC-LA01_CC_N"
set_property PACKAGE_PIN N19 [get_ports {bias[5]}];  # "FMC-LA01_CC_P" - corrected 6/6/16 GE
set_property PACKAGE_PIN P18 [get_ports {bias[6]}];  # "FMC-LA02_N"
set_property PACKAGE_PIN P17 [get_ports {bias[7]}];  # "FMC-LA02_P"
set_property PACKAGE_PIN P22 [get_ports {din[0]}];  # "FMC-LA03_N"
set_property PACKAGE_PIN N22 [get_ports {din[1]}];  # "FMC-LA03_P"
set_property PACKAGE_PIN M22 [get_ports {din[2]}];  # "FMC-LA04_N"
set_property PACKAGE_PIN M21 [get_ports {din[3]}];  # "FMC-LA04_P"
set_property PACKAGE_PIN K18 [get_ports {din[4]}];  # "FMC-LA05_N"
set_property PACKAGE_PIN J18 [get_ports {din[5]}];  # "FMC-LA05_P"
set_property PACKAGE_PIN L22 [get_ports {din[6]}];  # "FMC-LA06_N"
set_property PACKAGE_PIN L21 [get_ports {din[7]}];  # "FMC-LA06_P"
set_property PACKAGE_PIN T17 [get_ports {acc[22]}];  # "FMC-LA07_N"
set_property PACKAGE_PIN T16 [get_ports {acc[23]}];  # "FMC-LA07_P"
set_property PACKAGE_PIN J22 [get_ports {acc[24]}];  # "FMC-LA08_N"
set_property PACKAGE_PIN J21 [get_ports {acc[25]}];  # "FMC-LA08_P"
set_property PACKAGE_PIN R21 [get_ports {acc[26]}];  # "FMC-LA09_N"
set_property PACKAGE_PIN R20 [get_ports {acc[27]}];  # "FMC-LA09_P"
set_property PACKAGE_PIN T19 [get_ports {acc[28]}];  # "FMC-LA10_N"
set_property PACKAGE_PIN R19 [get_ports {acc[29]}];  # "FMC-LA10_P"
set_property PACKAGE_PIN N18 [get_ports {acc[30]}];  # "FMC-LA11_N"
set_property PACKAGE_PIN N17 [get_ports {acc[31]}];  # "FMC-LA11_P"
